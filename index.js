...
async function main () {
  ...
  function exportVariable (name, value) {
    ...
    core.exportVariable(`AAA${prefix}${name}`, value)
  }
  ...
  function setOutput(name, value) {
    ...
    core.setOutput(`AAA${prefix}${name}`, value)
  }
  ...
  core.info(`Current version is AAA${prefix}${latestTag.name}`)
  core.info(`Next version is AAA${prefix}v${next}`)
